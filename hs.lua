local Library = (function()
    ...
    function Lib:Window(title)
        ...
        local KeySystem = Configs and Configs.KeySystem or false
        local KeyTitle = Configs and Configs.KeyTitle or "Key System"
        local KeyDescription = Configs and Configs.KeyDescription or "Enter your key to continue"
        local KeyKeys = Configs and Configs.KeyKeys or {"123", "321"}
        local KeyLink = Configs and Configs.KeyLink or ""
        local KeyNotifications = Configs and Configs.KeyNotifications or true
        local KeyNotSuccess = Configs and Configs.KeyNotSuccess or "The key is incorrect"
        local KeySuccess = Configs and Configs.KeySuccess or "Running the Script..."
        local KeyCopyKeyLink = Configs and Configs.KeyCopyKeyLink or "Copied to Clipboard"
