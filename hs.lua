    ...
    TextBox.FocusLost:Connect(function(enterPressed)
        ...
        function Elements:Dropdown(text, options, callback)
            ...
            DropButton.MouseButton1Click:Connect(function()
                ...
                function Elements:ProfileCard(config)
            ...
            MainContainer.Name = "ProfileCard"
            MainContainer.Parent = Page
            MainContainer.BackgroundColor3 = Color_Sec
            MainContainer.Size = UDim2.new(1, 0, 0, 140)

            UICorner.CornerRadius = UDim.new(0, 6)
            UICorner.Parent = MainContainer

            AvatarImage.Name = "AvatarImage"
            AvatarImage.Parent = MainContainer
            AvatarImage.BackgroundTransparency = 1
            AvatarImage.Position = UDim2.new(0, 10, 0.5, -55)
            AvatarImage.Size = UDim2.new(0, 110, 0, 110)
            AvatarImage.Image = "rbxthumb://type=AvatarBust&id=" .. Player.UserId .. "&x=150&y=150"

            RightContent.Name = "RightContent"
            RightContent.Parent = MainContainer
            RightContent.BackgroundTransparency = 1
            RightContent.Position = UDim2.new(0, 130, 0, 10)
            RightContent.Size = UDim2.new(1, -140, 1, -20)

            UIListLayout.Parent = RightContent
            ...
            WelcomeLabel.Parent = RightContent
            WelcomeLabel.BackgroundTransparency = 1
            WelcomeLabel.Size = UDim2.new(1, 0, 0, 22)
            WelcomeLabel.Font = Enum.Font.SourceSansPro
            WelcomeLabel.Text = "Hey, " .. Player.Name .. " !"
            WelcomeLabel.TextColor3 = Color_Text
            ...
            DiscordButton.Size = UDim2.new(1, 0, 0, 22)
            DiscordButton.Font = Enum.Font.SourceSansPro
            DiscordButton.Text = "Discord"
            DiscordButton.TextColor3 = Color3.fromRGB(210, 210, 210)
            DiscordButton.TextSize = 18
            DiscordButton.LayoutOrder = 2

            SettingsButton.Name = "SettingsButton"
            SettingsButton.Parent = RightContent
            SettingsButton.BackgroundTransparency = 1
            SettingsButton.Size = UDim2.new(1, 0, 0, 22)
            SettingsButton.Font = Enum.Font.SourceSansPro
            SettingsButton.Text = "Settings (Soon)"
            SettingsButton.TextColor3 = Color_TextDim
            SettingsButton.TextSize = 16
            SettingsButton.LayoutOrder = 3

            DiscordButton.MouseButton1Click:Connect(function()
                if setclipboard then
                    setclipboard(config.DiscordLink or "https://discord.gg/fvSjxZ2hdD")
                end
                if getgenv().MakeNotifi then
                    getgenv().MakeNotifi({
                        Title = "HexHubX",
